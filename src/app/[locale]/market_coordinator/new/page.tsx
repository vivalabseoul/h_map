...
import { createFleaMarket } from '@/lib/database';
import type { Locale } from '@/types';
import AddressSearch from '@/components/AddressSearch';
import ImageUpload from '@/components/ImageUpload';

export default function CreateFleaMarketPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/market_coordinator');
    } catch (err) {
      console.error(err);
      alert('플리마켓 등록에 실패했습니다.');
    } finally {
      setLoading(false);
    }
  };
