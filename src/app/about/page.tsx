    ...
    <main>
      ...
      <div className="page-container">
        <div className="card" style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h1 style={{ marginBottom: 'var(--space-2)' }}>Handmade Map</h1>
          <p style={{ color: 'var(--color-text-secondary)', marginBottom: 'var(--space-8)' }}>
            Discover Local Craft Workshops Worldwide
          </p>
          ...
          <div style={{ lineHeight: '1.8', color: 'var(--color-text-secondary)', textAlign: 'left' }}>
            ...
            <p style={{ marginBottom: 'var(--space-6)' }}>
              Handmade Map은 전 세계의 숨겨진 지역 공방(공예 스튜디오)을 발굴하고, 여행자와 로컬 창작자를 연결하는 시각적 기반의 위치 서비스입니다.
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              ...
              <li style={{ marginBottom: 'var(--space-2)' }}><strong>Email:</strong> lunantshop@gmail.com</li>
