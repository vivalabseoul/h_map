      ...
      <div className="page-container">
        <div className="card" style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <div style={{ lineHeight: '1.8', color: 'var(--color-text-secondary)' }}>
            ...
            <p>본 약관은 Handmade Map이 제공하는 위치 기반 공방 검색 및 예약 서비스(이하 "서비스")의 이용과 관련하여 회사와 회원 간의 권리, 의무 및 책임사항 등을 규정함을 목적으로 합니다.</p>
            <br />
            <p><strong>제 2 조 (용어의 정의)</strong></p>
            <p>"회원"이란 본 약관에 따라 회사와 이용계약을 체결하고 회사가 제공하는 서비스를 이용하는 자를 말합니다.<br/>
            "강사"란 서비스를 통해 자신의 공방(스튜디오) 및 워크샵을 등록하고 회원을 상대로 서비스를 제공하는 자를 말합니다.</p>
            <br />
